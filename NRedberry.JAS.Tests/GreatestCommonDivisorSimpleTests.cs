...
public sealed class GreatestCommonDivisorSimpleTests
{
    [Fact]
    public void ShouldComputeBaseGcdAndZeroResultant()
    {
        GreatestCommonDivisorSimple<BigRational> gcd = new();
        ...
        gcd.BaseResultant(first, second).IsZero().ShouldBeTrue();
    }
