...
public sealed class PermutationsCreateTranspositionTests
{
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => _ = GroupPermutations.CreateTransposition(-1));
    ...
    public void ShouldSwapFirstTwoEntriesInSingleArgumentOverloadWhenDimensionGreaterThanOne()
    {
        ...
        transposition.ShouldBe([1, 0, 2, 3, 4]);
    }
    ...
    public void ShouldSwapRequestedPositionsInThreeArgumentOverload()
    {
        ...
        transposition.ShouldBe([0, 4, 2, 3, 1, 5]);
    }
    ...
    public void ShouldReturnIdentityWhenPositionsAreEqualInThreeArgumentOverload()
    {
        ...
        transposition.ShouldBe([0, 1, 2, 3]);
    }
    ...
    {
        var exception = Should.Throw<ArgumentException>(() => _ = GroupPermutations.CreateTransposition(-1, 0, 0));
    ...
    {
        Should.Throw<ArgumentOutOfRangeException>(() => _ = GroupPermutations.CreateTransposition(dimension, position1, position2));
    }
