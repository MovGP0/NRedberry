...
public sealed class UnsafeCombinatoricsTests
{
    ...
    {
        Permutation permutation = UnsafeCombinatorics.CreateUnsafe(new[] { 0, 1, 2 });
    ...
    {
        Permutation permutation = UnsafeCombinatorics.CreateUnsafe(new[] { 1, 0 });
    ...
    {
        Symmetry symmetry = UnsafeCombinatorics.CreateUnsafe(new[] { 1, 0 }, true);
