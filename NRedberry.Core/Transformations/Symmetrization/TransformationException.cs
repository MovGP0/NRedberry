...
{
    public TransformationException(string message, params Tensor[] tensors) : base(message, tensors)
    {
    }
    ...
    public TransformationException(params Tensor[] tensor) : base(tensor)
    {
    }
}