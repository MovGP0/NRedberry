...
public sealed class OneLoopCountertermsTest
{
    ...
    public void TestGravityGhosts0()
    {
        ...
        ShouldEqualTensor(ExpandTransformation.Expand(a), expected);
    }
    ...
    public void TestVectorField()
    {
        ...
        ShouldEqualTensor(ExpandTransformation.Expand(actual), expected);
        ...
        ShouldEqualTensor(expected, actual);
    }
    ...
    public void TestGravityGhosts()
    {
        ...
        ShouldEqualTensor(FactorTransformation.Factor(a, false), expected);
    }
    ...
    private static void ShouldEqualTensor(Tensor actual, Tensor expected)
    {
    ...
    private static void ShouldBeTrue(bool condition)
    {
