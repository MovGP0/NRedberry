...
- **GB:** handles [Gröbner basis](https://en.wikipedia.org/wiki/Gr%C3%B6bner_basis)
- **UFD:** handles [unique factorization domains](https://en.wikipedia.org/wiki/Unique_factorization_domain)
